...
activities = {
    ...
    "Basketball Team": {
        "description": "Join our competitive basketball team and compete in interschool tournaments",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu"]
    },
    "Volleyball Club": {
        "description": "Develop volleyball skills and participate in friendly matches",
    ...
    "Drama Club": {
        "description": "Perform in school plays and musicals, develop acting and stagecraft skills",
